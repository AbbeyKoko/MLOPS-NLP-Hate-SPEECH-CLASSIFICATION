...
list_of_files = [
    ...
    f"{project_name}/pipeline/01_data_ingestion_train_pipeline.py",
    f"{project_name}/pipeline/02_data_validation_train_pipeline.py",
    f"{project_name}/pipeline/03_data_transformation_train_pipeline.py",
    f"{project_name}/pipeline/04_model_training_train_pipeline.py",
    f"{project_name}/pipeline/05_model_evaluation_train_pipeline.py",
    f"{project_name}/pipeline/06_model_deployment_train_pipeline.py",
